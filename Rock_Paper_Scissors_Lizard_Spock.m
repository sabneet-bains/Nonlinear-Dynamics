% rpslk_system.m - Simulation of the Rock-Paper-Scissors-Lizard-Spock system
%
...
a = 1; % Set to 1 for the standard system
...
%% Post-Processing: Set near-zero values to exactly zero
p(abs(p) < 1e-3) = 0;
